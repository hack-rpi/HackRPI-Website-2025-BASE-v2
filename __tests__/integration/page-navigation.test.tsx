...
jest.mock('@/components/nav-bar/nav-bar', () => {
  ...
  return jest.fn(({ showOnScroll }: { showOnScroll: boolean }) => (
    <div data-testid="nav-bar" data-show-on-scroll={showOnScroll}>
      ...
      <a data-testid="event-link" href="/event">Event</a>
      <a data-testid="resources-link" href="/resources">Resources</a>
      <a data-testid="last-year-link" href="/last-year">Last Year</a>
    </div>
  ));
});
...
jest.mock('@/components/about-us', () => {
  return function MockAboutUs() {
    return <div data-testid="about" id="about">About Component</div>;
  };
});

jest.mock('@/components/team/team', () => {
  return function MockTeam() {
    return <div data-testid="team" id="team">Team Component</div>;
  };
});

jest.mock('@/components/sponsors', () => {
  return function MockSponsors() {
    return <div data-testid="sponsors" id="sponsors">Sponsors Component</div>;
  };
});

jest.mock('@/components/faq/faq', () => {
  return function MockFAQ() {
    return <div data-testid="faq" id="faq">FAQ Component</div>;
  };
});
