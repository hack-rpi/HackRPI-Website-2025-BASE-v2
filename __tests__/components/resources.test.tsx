...
describe('Resources Page', () => {
  ...
  it('renders external resource links correctly', () => {
    ...
    const claudeLink = hackrpiLinks.find(link => 
      link.getAttribute('href')?.includes('docs.anthropic.com')
    );
    ...
    const wolframLink = hackrpiLinks.find(link => 
      link.getAttribute('href')?.includes('wolfram.com')
    );
