...
jest.mock('@/public/sponsors/sponsors.json', () => ({
  "Obsidian": [
    {
...
describe('Sponsors Component', () => {
  ...
  it('applies correct styling to the sponsor container', () => {
    ...
    const container = screen.getByText('Thank you to our sponsors that make HackRPI possible!').parentElement?.parentElement;
