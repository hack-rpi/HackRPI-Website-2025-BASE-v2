...
export default function HackRPILink({
	...
	return (
		<NextLink
			href={href}
			className={`${className} group border-hackrpi-pink border-2 text-hackrpi-orange hover:bg-hackrpi-pink hover:text-hackrpi-yellow transition-colors duration-200 font-sans font-medium relative `}
		>
			{children}
			<svg
				className="absolute top-1 right-1 group-hover:fill-hackrpi-yellow fill-hackrpi-pink transition-colors duration-200"
